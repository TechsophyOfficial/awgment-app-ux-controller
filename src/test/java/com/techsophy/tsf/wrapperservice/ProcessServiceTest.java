...
public class ProcessServiceTest {
    ...
    void deleteProcessByIdTestWhileTaskNotFound() throws JsonProcessingException {
        ...
        Mockito.when(map.get(any())).thenThrow(TaskNotExitsException.class);
        Assertions.assertThrows(TaskNotExitsException.class, () -> processService.deleteProcessById("no", "id"));
    }
}
