...
public class CamundaApiConstants
{
    ...
    public static final String GET_TASK = ENGINE_REST + TASK_CONSTANT;
    ...
    public static final String GET_ALL_TASK = CUSTOM_CAMUNDA_BASE_URL + TASK_CONSTANT;
    ...
    public static final String CASEINSTANCE_CONSTANT = "/case-instance/";
    ...
    public static final String GET_GROUP_TASK =ENGINE_REST+TASK_CONSTANT;
    public static final String GET_GROUP_TASK_CASEINSTANCE =ENGINE_REST+CASEINSTANCE_CONSTANT;
    ...
    public static final String ALLTASK_CASE_INSTANCE =ENGINE_REST+CASEINSTANCE_CONSTANT;
    ...
    public static final String GROUP_CASE_INSTANCE=ENGINE_REST+CASEINSTANCE_CONSTANT;
    ...
    public static final String UPDATE_TASK = ENGINE_REST + TASK_CONSTANT;
    ...
    public static final String ALL_TASK_CASE_INSTANCE=ENGINE_REST+CASEINSTANCE_CONSTANT;
