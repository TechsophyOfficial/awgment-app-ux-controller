...
public class ProcessServiceImpl implements ProcessService
{
    ...
    @Override
    public void deleteProcessById(String ticketNumber,String formDataId) throws JsonProcessingException
    {
        ...
        {
            throw new TaskNotExistsException(TASK_NOT_EXIST,UNABLE_TO_FIND_THE_TASK);
        ...
        if(response.getStatusCode().is2xxSuccessful())
        {
            ...
            statusCodeUpdateDTO.setId(formDataId);
            ...
            try {
                ...
                throw new FailedTaskDeletionException( FAILED_TO_DELETE_THE_TASK,"Failed to delete the task");
