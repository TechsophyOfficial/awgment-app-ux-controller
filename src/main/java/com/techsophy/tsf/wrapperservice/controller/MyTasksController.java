...
public interface MyTasksController
{
    ...
    ApiResponse<String>  myTasksCount(@RequestBody MyTasksDTO myTasksDTO) throws JsonProcessingException;

    @PostMapping(ApplicationEndpointConstants.MY_TASKS)
    @PreAuthorize(CREATE_OR_ALL_ACCESS)
    ApiResponse<List<Map<String, Object>>> getAllMyTasks(@RequestBody MyTasksDTO myTasksDTO,
    ...
    ApiResponse<List<Map<String, Object>>>  getMyTasksHistory(@RequestParam(value=CASE_INSTANCEID) String caseInstanceId) throws JsonProcessingException;

    @GetMapping(ApplicationEndpointConstants.MY_TASKS+ApplicationEndpointConstants.ID)
    @PreAuthorize(READ_OR_ALL_ACCESS)
    ApiResponse<Map<String,Object>>  getMyTasksById(@PathVariable(MessageConstants.ID) String id) throws JsonProcessingException;
